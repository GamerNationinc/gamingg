...
a pack you actually carry (a per-good weight table with stone as the yardstick,
one load byte shared by the live game and the headless one, a limit that slows
you first and hard-stops you second, drops that lie in the cell they came out of
...
world; drops arrive on the floor rather than tumbling to it; the pack panel lists at
most twelve kinds; and selling still comes out of the base pile rather than the
pack, so a haul away from home has to be carried and cannot be put down.
