...
const VERBS: &[Verb] = &[
    ...
    Verb { name: "weather", help: "THE SKY, THE WIND, AND HOW DRY THE WOODS ARE" },
    ...
    Verb { name: "wreck", help: "WHAT YOU LOST, AND WHERE IT IS LYING" },
...
pub fn parse(line: &str) -> Parsed {
    ...
    match verb.as_str() {
        ...
        "wreck" | "wrecks" | "salvage" => Parsed::Ask("wreck".into(), rest),
